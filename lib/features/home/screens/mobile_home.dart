...
import 'package:jala_form/features/groups/screens/group_list_screen.dart';
...
import 'package:jala_form/features/forms/screens/available_forms_screen.dart';
import 'package:jala_form/features/forms/screens/form_builder_screen.dart';
import 'package:jala_form/features/forms/screens/my_forms_screen.dart';
import 'package:jala_form/features/profile/profile_screen.dart';
...
class _MobileHomeScreenState extends State<MobileHomeScreen> with TickerProviderStateMixin {
  ...
  FormBuilderScreen _createFormBuilderScreen() {
    print("DEBUG: Creating form builder screen");
    return FormBuilderScreen(
      onFormContentChanged: () {
        print("DEBUG: Form content changed callback triggered");
        setState(() {
          _formHasUnsavedChanges = true;
        });
        print("DEBUG: Set unsaved changes to true");
      },
      checkUnsavedChanges: () {
        print("DEBUG: Checking unsaved changes: $_formHasUnsavedChanges");
        return _formHasUnsavedChanges;
      },
      resetFormCallback: () {
        print("DEBUG: Reset form callback triggered");
        setState(() {
          _formHasUnsavedChanges = false;
        });
        print("DEBUG: Reset unsaved changes to false");
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final headerHeight = isTablet ? 90.0 : 70.0;
