...
import 'package:jala_form/features/forms/models/form_state_interface.dart';
                                    ...
                                    const Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Add basic information about your form',
                                            style: TextStyle(
                                              fontSize: 13,
                                              color: Colors.grey,
                                            ),
  ...
  Future<void> _saveForm() async {
    if (_formKey.currentState!.saveAndValidate()) {
      ...
      try {
        ...
        if (mounted) {
          // Remove listeners temporarily to prevent triggering onFormContentChanged
          _titleController.removeListener(_markAsModified);
          _descriptionController.removeListener(_markAsModified);

          // Clear form data without triggering listeners
          _titleController.clear();
          _descriptionController.clear();
          ...
          // NOW notify parent that form has been saved (after clearing everything)
          widget.resetFormCallback?.call();
