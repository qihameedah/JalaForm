...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withAlpha(127)), // 50% opacity

    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withAlpha(127)), // 50% opacity
  ); // TextTheme
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withAlpha(127), // 50% opacity
    ),

    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withAlpha(127)), // 50% opacity
  ); // TextTheme
}
